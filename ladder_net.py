...
def get_ladder_network_fc(layer_sizes=[784, 1000, 500, 250, 250, 250, 10], 
    ...
    def encoder(inputs, noise_std):
        ...
        for l in range(1, L+1):
            ...
            if l == L:
                # h = Activation('sigmoid')(betas[l - 1](z))
    ...
    # tr_m.compile(keras.optimizers.Adam(learning_rate=0.07), 'binary_crossentropy', metrics=['accuracy'])
    tr_m.compile(keras.optimizers.Adam(learning_rate=0.02), 'categorical_crossentropy', metrics=['accuracy'])
